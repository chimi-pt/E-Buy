 	...
 	<div class="row pc-5">
 		<div class="col-md-7">
 			<div class="shopping-cart">
 				<h6 class="text-capitalize" style="color: orange; font-size: 30px;"><?=  $_SESSION ['username'] ?>'s Cart</h6>
 				<hr>
					<?php 
					$total=0;
						...
						foreach ($product_id as $id) 
						{
							if ($row['id']==$id) 
							{
								...
								$total=$total+(int)$row['product_price'];
									...
									$sql = "INSERT INTO numbero(OrderID,ProductName,ProductPrice)VALUES('$orderid','$namee','$prize')";
 		...
 		<?php
 			if (isset($_POST['submitOrder'])) {
 				...
 				$sql = "INSERT INTO numbero(UserName,OrderID,Total)VALUES('$iad','$totalid','$tootal')";
				mysqli_query($link, $sql);	
