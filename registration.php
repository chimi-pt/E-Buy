    	...
    	<div class="row">
    		<div class="col-md-6 login-left">
    			...
    			<div class="form-group">
					...
					<input type="text" name="uname" value="<?php echo $name;?>"class="form-control" required>
				...
				<div class="form-group">
					<label for="user_name">Second Name</label>
					<input type="text" name="sname" value="<?php echo $sname;?>"class="form-control" required>
