...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <input type="submit" onClick="window.location='login.php'"  name="login" value="Login"/>
                    </div>
        ...
        <label for="usertype" style="font-weight: bold;">Select User:</label>
                                    ...
                                    <?php endif; ?>
                                     ...
                                     <img src="portrait-blank-male.png" onClick="triggerClick()" id="profileDisplay">
                                      ...
                                      <label>Profile Image</label>
                                        ...
                                        <div class="form-group">
                                            <input type="text"  name="resid" class="form-control"  placeholder="Your City *" value="" required/>
                                        </div>
                                       
                                         <button type="submit" name="save" class="  btnRegister">Register</button>
