...
<body>
	...
	<div class="menu" id="menu" >
		<div id="menu-bar" onclick="onClickMenu()">
			...
			<ul class="nav" id="nav">
				...
				<li ><a class="nave" href="login.php">Login</a></li>
			</ul>
		</div>
	...
	<header class="header " id="home" >
		<div class="hero">
			...
			<a href="login.php" class="hero-button pulsate">Login</a>
		</div>
	</header>
		...
		<article class="menu-image"></article>
			<article class="menu-text">
				<div class="menu-text-center">
					...
					<a href="registration.php" class="hero-button " style="background: rgba(10,10,10); color: orange;">Explore</a>
				</div>
	...
	<section id="food">
		<div>
			<h2 class="title-text" style="color: white!important;">Food Fusion</h2>
		</div>
		<div class="food-container">
			...
			<article class="food-card">
				...
				<div class="img-footer">
					...
					<div class="footer-btn"><button type="button" class="food-btn">Order Now</button>
					</div>
				</div>
			</article>
	...
	<section id="gallery">
		<div>
			<h2 class="title-text" style="color: white!important;">Main Dishes</h2>
		</div>
